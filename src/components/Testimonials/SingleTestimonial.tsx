...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  <div className="shadow-two hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark rounded-xs bg-white p-8 duration-300 lg:px-5 xl:px-8 h-[300px] flex flex-col justify-between">
    <div>
