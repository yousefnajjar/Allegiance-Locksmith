      ...
      <div className="container">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              ...
              <p className="text-body-color dark:text-body-color-dark mb-6 text-base leading-relaxed">
                Serving the Greater Houston Area since 2021. Rest easy knowing
                your security is in reliable hands. Choose Allegiance Locksmith
                for trusted solutions tailored to your needs.
              </p>
              <p className="text-body-color dark:text-body-color-dark mb-6 text-base">
                <strong>Email:</strong>
                <a href="mailto:allegiancelocksmith.llc@gmail.com">
                  allegiancelocksmith.llc@gmail.com
                </a>
                <br />
                <strong>Phone:</strong>
                <a href="tel:+17132714444">(713) 271-4444</a>
                <br />{" "}
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              ...
              <ul>
                <li>
                  <Link
                    href="/services/expert-locksmith"
        ...
        <div className="py-8">
          <p className="text-body-color text-center text-base dark:text-white">
            © {new Date().getFullYear()} Allegiance Locksmith. All rights
            reserved.
          </p>
        </div>
      </div>
      ...
      <div className="absolute top-14 right-0 z-[-1]">
        ...
        >
          ...
          <mask
            ...
            height="99"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#0056ad" />
          </mask>
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#0056ad" stopOpacity="0.62" />
            ...
            >
              ...
              <stop offset="1" stopColor="#0056ad" stopOpacity="0.51" />
            </linearGradient>
            <linearGradient
